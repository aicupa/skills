...
Head view tips:
- Head views receive `plugin-tree-update` automatically on every tree change — use this for client-side analysis instead of calling the service when only read access is needed
